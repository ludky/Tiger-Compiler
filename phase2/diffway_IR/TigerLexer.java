...
public class TigerLexer extends Lexer {
	...
	public final void mFUNCTION() throws RecognitionException {
		try {
			...
			// Tiger.g:109:13: ( 'function' )
			// Tiger.g:109:17: 'function'
			{
			match("function"); 
	...
	public final void mBEGIN() throws RecognitionException {
		try {
			int _type = BEGIN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:110:13: ( 'begin' )
			// Tiger.g:110:17: 'begin'
			{
			match("begin"); 
	...
	public final void mARRAY() throws RecognitionException {
		try {
			int _type = ARRAY;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:115:13: ( 'array' )
			// Tiger.g:115:17: 'array'
			{
			match("array"); 
	...
	public final void mFIXEDPT() throws RecognitionException {
		try {
			int _type = FIXEDPT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:118:13: ( 'fixedpt' )
			// Tiger.g:118:17: 'fixedpt'
			{
			match("fixedpt"); 
	...
	public final void mENDIF() throws RecognitionException {
		try {
			int _type = ENDIF;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:122:13: ( 'endif' )
			// Tiger.g:122:17: 'endif'
			{
			match("endif"); 
	...
	public final void mWHILE() throws RecognitionException {
		try {
			int _type = WHILE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:124:13: ( 'while' )
			// Tiger.g:124:17: 'while'
			{
			match("while"); 
	...
	public final void mENDDO() throws RecognitionException {
		try {
			int _type = ENDDO;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:126:13: ( 'enddo' )
			// Tiger.g:126:17: 'enddo'
			{
			match("enddo"); 
	...
	public final void mBREAK() throws RecognitionException {
		try {
			int _type = BREAK;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:129:13: ( 'break' )
			// Tiger.g:129:17: 'break'
			{
			match("break"); 
	...
	public final void mRETURN() throws RecognitionException {
		try {
			int _type = RETURN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:130:13: ( 'return' )
			// Tiger.g:130:17: 'return'
			{
			match("return"); 
	...
	public final void mIdentifier() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:174:5: ( Letter ( Letter | Digit | '_' )* )
			// Tiger.g:174:9: Letter ( Letter | Digit | '_' )*
			{
			mLetter(); 

			// Tiger.g:174:16: ( Letter | Digit | '_' )*
			loop2:
			while (true) {
				int alt2=2;
	...
	public final void mIntegerLiteral() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:178:5: ( '0' | NaturalNumber ( Digit )* )
			int alt4=2;
			...
			switch (alt4) {
				case 1 :
					...
					break;
				case 2 :
					// Tiger.g:178:15: NaturalNumber ( Digit )*
					{
					mNaturalNumber(); 

					// Tiger.g:178:29: ( Digit )*
					loop3:
					while (true) {
						int alt3=2;
	...
	public final void mFixedPointLiteral() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:182:5: ( IntegerLiteral '.' Digit ( Digit ( Digit )? )? )
			// Tiger.g:182:9: IntegerLiteral '.' Digit ( Digit ( Digit )? )?
			{
			mIntegerLiteral(); 
			...
			switch (alt6) {
				case 1 :
					// Tiger.g:182:35: Digit ( Digit )?
					{
					mDigit(); 

					// Tiger.g:182:41: ( Digit )?
					int alt5=2;
	...
	public final void mCOMMENT() throws RecognitionException {
		try {
			int _type = COMMENT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:186:5: ( '/*' ( options {greedy=false; } : . )* '*/' )
			// Tiger.g:186:9: '/*' ( options {greedy=false; } : . )* '*/'
			{
			match("/*"); 

			// Tiger.g:186:14: ( options {greedy=false; } : . )*
			loop7:
			while (true) {
				int alt7=2;
