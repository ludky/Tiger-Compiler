// $ANTLR 3.5.2 Tiger.g 2015-02-22 22:47:59
...
public class TigerLexer extends Lexer {
	...
	public final void mFUNCTION() throws RecognitionException {
		try {
			...
			// Tiger.g:12:13: ( 'function' )
			// Tiger.g:12:17: 'function'
			{
			match("function"); 
	...
	public final void mFIXEDPT() throws RecognitionException {
		try {
			int _type = FIXEDPT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:21:13: ( 'fixedpt' )
			// Tiger.g:21:17: 'fixedpt'
			{
			match("fixedpt"); 
	...
	public final void mRETURN() throws RecognitionException {
		try {
			int _type = RETURN;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:33:13: ( 'return' )
			// Tiger.g:33:17: 'return'
			{
			match("return"); 
	...
	public final void mIdentifier() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:77:5: ( Letter ( Letter | Digit | '_' )* )
			// Tiger.g:77:9: Letter ( Letter | Digit | '_' )*
			{
			mLetter(); 

			// Tiger.g:77:16: ( Letter | Digit | '_' )*
			loop2:
			while (true) {
				int alt2=2;
	...
	public final void mIntegerLiteral() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:81:5: ( '0' | NaturalNumber ( Digit )* )
			int alt4=2;
			...
			switch (alt4) {
				case 1 :
					...
					break;
				case 2 :
					// Tiger.g:81:15: NaturalNumber ( Digit )*
					{
					mNaturalNumber(); 
	...
	public final void mFixedPointLiteral() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:85:5: ( ( IntegerLiteral '.' Digit | Digit Digit | Digit Digit Digit ) )
			// Tiger.g:85:9: ( IntegerLiteral '.' Digit | Digit Digit | Digit Digit Digit )
			{
			// Tiger.g:85:9: ( IntegerLiteral '.' Digit | Digit Digit | Digit Digit Digit )
			int alt5=3;
			...
			switch (alt5) {
				case 1 :
					// Tiger.g:85:10: IntegerLiteral '.' Digit
					{
					mIntegerLiteral(); 
				...
				case 2 :
					...
					break;
				case 3 :
					// Tiger.g:85:51: Digit Digit Digit
					{
					mDigit(); 
	...
	public final void mCOMMENT() throws RecognitionException {
		try {
			int _type = COMMENT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// Tiger.g:89:5: ( '/*' ( options {greedy=false; } : . )* '*/' )
			// Tiger.g:89:9: '/*' ( options {greedy=false; } : . )* '*/'
			{
			match("/*"); 

			// Tiger.g:89:14: ( options {greedy=false; } : . )*
			loop6:
			while (true) {
				int alt6=2;
